...
model.load_model(r'C:\Users\ariib\.spyder-py3\xgb_model.json')
...
def main(): 
    ...
    st.write('')
    st.markdown("##### Are you planning to sell your car? Let's try evaluating the price.")
    ...
    s2 = st.selectbox('Are you a dealer or an individual ?', ('Individual','Dealer'))
    ...
    try: 
        if st.button('Predict'):
            ...
            if prediction>0:
                ...
                st.warning("Sorry, You will be not able to sell this car !!")
    except:
